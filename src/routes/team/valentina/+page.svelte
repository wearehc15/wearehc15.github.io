<article class="py-14 md:py-16 lg:py-24">
	<div class="px-4">
		<h1 class="md:text-center text-6xl md:text-7xl lg:text-9xl tracking-wide text-cyan-950 mt-9 mb-4 lg:mt-16 lg:mb-11">Valentina <span class="italic text-[#fca806]">Dainelli</span></h1>
