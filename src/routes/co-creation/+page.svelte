	...
	<div class="max-w-6xl mx-auto px-4">
		...
		<div class="my-6 md:my-12 lg:my-16 text-center text-md md:text-xl flex flex-col lg:flex-row gap-4 lg:gap-6 flex-wrap">
			<div class="md:mx-auto md:w-1/2 group block relative lg:w-[calc(100%/3-16px)] rounded-lg bg-white p-4 md:p-6">
				...
				<ul class="text-left">
					<li class="mb-1.5"><i class="fa-regular fa-stop fa-lg mr-2"></i> Motivations and Vision</li>
					<li class="mb-1.5"><i class="fa-regular fa-stop fa-lg mr-2"></i> Passions</li>
					<li class="mb-1.5"><i class="fa-regular fa-stop fa-lg mr-2"></i> Current obstructions</li>
					<li class="mb-1.5"><i class="fa-regular fa-stop fa-lg mr-2"></i> What you bring to the table</li>
			...
			<div class="md:mx-auto md:w-1/2 group block relative lg:w-[calc(100%/3-16px)] rounded-lg bg-white p-4 md:p-6">
				...
				<ul class="text-left">
					<li class="mb-1.5"><i class="fa-regular fa-stop fa-lg mr-2"></i> How to get there</li>
					<li class="mb-1.5"><i class="fa-regular fa-stop fa-lg mr-2"></i> Strategy</li>
					<li class="mb-1.5"><i class="fa-regular fa-stop fa-lg mr-2"></i> What you want to do</li>
